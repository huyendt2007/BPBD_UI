...
### 4.1.X. Quản lý yêu cầu đã đăng ký Yêu cầu cung cấp bản sao văn bản chứng nhận
...
– Cho phép Khách hàng thực hiện thanh toán thông qua Cổng thanh toán trực tuyến ngay từ Danh sách hoặc màn hình Xem chi tiết đối với hồ sơ đang ở trạng thái "Chờ thanh toán".
...
– Cổng thanh toán trực tuyến sẵn sàng tiếp nhận giao dịch tại thời điểm Khách hàng thực hiện thanh toán.

---

#### 4.1.X.2. Tab "Yêu cầu cung cấp bản sao"
...
| Loại cung cấp bản sao | Enum(String(50)) | Không | Tất cả | Lọc theo giá trị đã chọn ở [Màn hình Yêu cầu cấp bản sao văn bản chứng nhận đăng ký biện pháp bảo đảm](SRS_YC_cung_cap_ban_sao_van_ban_chung_nhan.md#41162-uc149mh01---man-hinh-yeu-cau-cap-ban-sao-van-ban-chung-nhan-dang-ky-bien-phap-bao-dam):<br>– Tất cả<br>– Bản sao điện tử<br>– Bản sao giấy |
...
| 3 | Row Click | Thao tác dòng | Mở **Màn hình Chi tiết yêu cầu cung cấp bản sao** tương ứng với yêu cầu được chọn. |
| 4 | Thanh toán | Nút | Khi click, hệ thống đóng gói thông tin thanh toán (Mã hồ sơ, Số tiền phải thu, Nội dung thanh toán, Mã đơn vị thụ hưởng, Return URL) và chuyển hướng sang [Cổng thanh toán trực tuyến](UC158_Quan_ly_thanh_toan_phi.md). |
| 5 | Tải file | Nút | Tải đúng file PDF bản sao văn bản chứng nhận đã được Lãnh đạo ký số xuống thiết bị của Khách hàng. |

---

#### 4.1.X.4. MH02 - Màn hình Chi tiết yêu cầu cung cấp bản sao

##### 4.1.X.4.1. Màn hình

Mở khi Khách hàng click vào một dòng dữ liệu tại Tab "Yêu cầu cung cấp bản sao" (mục 4.1.X.3). 
...
| Khối thông tin chi tiết hồ sơ gốc | - | Có | Theo hồ sơ gốc | Hiển thị khi Trạng thái là "Đã duyệt - chờ trả kết quả" hoặc "Hoàn thành". Hiển thị theo đúng cấu trúc dùng chung tại [Cấu trúc chi tiết danh sách hồ sơ đăng ký giao dịch bảo đảm / hợp đồng](UC190_to_UC192_Tra_cuu_ho_so_theo_ma_so_su_dung_CSDL.md#cau-truc-chi-tiet-danh-sach-ho-so-dang-ky-giao-dich-bao-dam-hop-dong). Không cho phép chỉnh sửa. |
...
| Thời điểm thanh toán | Datetime | Không | Theo kết quả Cổng thanh toán | Thời điểm thanh toán thành công qua Cổng thanh toán. |
| Mã giao dịch thanh toán | String(100) | Không | Theo kết quả Cổng thanh toán | Mã giao dịch do Cổng thanh toán cấp. |
...
| 2 | Thanh toán | Nút | Bố trí tại Header góc trên bên phải màn hình (hiển thị khi hồ sơ ở trạng thái "Chờ thanh toán"). Khi click: Đóng gói thông tin thanh toán và chuyển hướng sang [Cổng thanh toán trực tuyến](UC158_Quan_ly_thanh_toan_phi.md). |
