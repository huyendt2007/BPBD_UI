...
| Loại chủ thể | Enum(String(50)) | Có | Công dân Việt Nam | Control UI: Hộp chọn.<br>Tham chiếu tại Danh mục dùng chung - Loại bên bảo đảm (Chủ thể) [DM_06]. |
...
| 7 | Tìm kiếm | Nút | Khi NSD bấm **Tìm kiếm**, hệ thống kiểm tra và xử lý theo các trường hợp bên dưới. |
...
| Trường thông tin | Kiểu dữ liệu | Bắt buộc | Mặc định | Mô tả |
| :--- | :--- | :---: | :--- | :--- |
| **I. Danh sách hồ sơ đăng ký giao dịch bảo đảm / hợp đồng** | Text(10000) | Tùy điều kiện | Theo dữ liệu nguồn của tính năng gọi | Control UI: Khối hiển thị chỉ đọc. Mỗi hồ sơ hiển thị thành 01 khối riêng theo cấu trúc các thông tin bên dưới. Không cho phép thêm, sửa, xóa hoặc thay đổi dữ liệu tại các màn hình sử dụng cấu trúc dùng chung này. |
...
| Loại biện pháp | Enum(String(255)) | Tùy điều kiện | Theo hồ sơ | Chỉ đọc. Chỉ hiển thị khi Loại hình giao dịch là **Biện pháp bảo đảm**; tham chiếu [DM_02]. |
| Loại hợp đồng | Enum(String(255)) | Tùy điều kiện | Theo hồ sơ | Chỉ đọc. Chỉ hiển thị khi Loại hình giao dịch là **Hợp đồng**; tham chiếu [DM_03]. |
| Trường hợp đăng ký | Enum(String(255)) | Có | Theo hồ sơ | Chỉ đọc. Tham chiếu [DM_04]. |
...
| Địa chỉ | String(500) | Có | Theo hồ sơ | Chỉ đọc. Hiển thị theo quy tắc **Địa chỉ chi tiết, Tỉnh/TP, Quốc gia**. |
...
| Loại chủ thể | Enum(String(50)) | Có | Theo hồ sơ | Chỉ đọc. Tham chiếu [DM_06]. |
...
| Địa chỉ kho hàng | String(500) | Tùy điều kiện | Theo hồ sơ | Control UI: Label chỉ đọc.<br>Chỉ hiển thị khi hồ sơ kê khai là **Kho hàng**. Hiển thị địa chỉ kho hàng theo quy tắc **Địa chỉ chi tiết, Tỉnh/TP, Quốc gia**. |
