...
| **II. Bảng danh sách tài khoản con** | | | |<br>- Trạng thái có dữ liệu: Hiển thị danh sách các bản ghi kết quả theo cấu trúc các cột quy định.<br>- Trạng thái không có dữ liệu (Empty State): Khi không tìm thấy kết quả phù hợp với điều kiện tìm kiếm, bảng hiển thị duy nhất 01 dòng căn giữa trên toàn bộ chiều rộng bảng (`colspan`), in nghiêng với nội dung: *"Không tìm thấy dữ liệu phù hợp với điều kiện tìm kiếm."*|
| Bảng danh sách tài khoản con | - | \- | 20 bản ghi/trang | Control UI: Bảng/Lưới hiển thị.<br>- Hiển thị danh sách các tài khoản con trực thuộc.<br>- Hiển thị mặc định **20 bản ghi/trang**.<br>- Mặc định hiển thị danh sách theo ngày tạo giảm dần.<br>- Trường hợp không tìm thấy tài khoản con nào thỏa mãn bộ lọc hoặc danh sách trống, hiển thị dòng chữ: "Không có dữ liệu".<br>- Trạng thái có dữ liệu: Hiển thị danh sách các bản ghi kết quả theo cấu trúc các cột quy định.<br>- Trạng thái không có dữ liệu (Empty State): Khi không tìm thấy kết quả phù hợp với điều kiện tìm kiếm, bảng hiển thị duy nhất 01 dòng căn giữa trên toàn bộ chiều rộng bảng (`colspan`), in nghiêng với nội dung: *"Không tìm thấy dữ liệu phù hợp với điều kiện tìm kiếm."*|
...
| > Cột: Thao tác | - | \- | \- | Control UI: Bảng/Lưới hiển thị.<br>\- Chứa các icon hành động: Sửa (UC006), Khóa/Mở khóa (UC007). |
...
| 3 | Sửa | Icon | \- Thao tác: NSD click icon Sửa ở cột Thao tác tương ứng với tài khoản con.<br>- Xử lý: Hệ thống hiển thị popup Form Cập nhật tài khoản trực thuộc (UC006.MH01), điền sẵn thông tin bản ghi và khóa trường Số giấy tờ ở chế độ chỉ đọc. |
| 4 | Khóa/Mở khóa | Icon | \- Thao tác: NSD click icon Khóa/Mở khóa ở cột Thao tác.<br>- Xử lý: Hệ thống mở popup Xác nhận đóng tài khoản trực thuộc (UC007.MH01). |
| 5 | Kết xuất Excel | Nút | \- Thao tác: NSD click nút Kết xuất.<br>- Xử lý: Hệ thống kiểm tra dữ liệu trước khi xuất file. |
...
| Tỉnh/TP | Enum(String(50)) | Có | Trống | Control UI: Hộp chọn/ô nhập động theo Quốc gia.<br>\- Nếu Quốc gia là "Việt Nam": Cho phép chọn tại Danh mục dùng chung - Tỉnh/Thành phố [DM_13].<br>\- Nếu Quốc gia khác "Việt Nam": Hiển thị ô nhập liệu dạng text để người dùng tự nhập. |
...
| Tỉnh/TP | Enum(String(50)) | Có | Theo bản ghi được chọn | Control UI: Hộp chọn/ô nhập động theo Quốc gia.<br>\- Nếu Quốc gia là "Việt Nam": Cho phép chọn tại Danh mục dùng chung - Tỉnh/Thành phố [DM_13].<br>\- Nếu Quốc gia khác "Việt Nam": Hiển thị ô nhập liệu dạng text để người dùng tự nhập. |
| Địa chỉ chi tiết | String(500) | Có | Theo bản ghi được chọn | \- Ghi thông tin địa chỉ chi tiết như Số nhà, đường phố, thôn xóm... |
