...
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | \- Thao tác: NSD click nút Tìm kiếm.<br>- Xử lý: Tự động cắt bỏ khoảng trắng thừa ở hai đầu từ khóa (Trim space). Lọc danh sách tài khoản con theo Từ khóa tìm kiếm và Trạng thái:<br>- Tìm kiếm gần đúng (chứa từ khóa) đối với các trường: Tên khách hàng, Email, Số điện thoại.<br>- Tìm kiếm chính xác đối với trường: Số giấy tờ (Số CCCD/CMND/Hộ chiếu). |
