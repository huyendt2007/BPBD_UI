...
| Tỉnh/Thành phố | Enum/String(255) | Không | Theo hồ sơ tài khoản | Chỉ đọc. Hiển thị tỉnh/thành phố nơi cư trú, trụ sở hoặc liên hệ gắn với hồ sơ tài khoản. |
| Địa chỉ chi tiết | String(500) | Không | Theo hồ sơ tài khoản | Chỉ đọc. Hiển thị địa chỉ chi tiết đã lưu gắn với hồ sơ tài khoản. |
