...
| **II. Vùng kết quả hiển thị** | - | - | 10 hồ sơ gốc/trang | Control UI: Tree Grid.<br>- Khi người dùng truy cập màn hình, hệ thống tự động tải danh sách các hồ sơ gốc thuộc quyền tài khoản đang đăng nhập.<br>- Bộ lọc tìm kiếm mặc định ở trạng thái trống, các combobox ở giá trị `Tất cả`.<br>- Sắp xếp mặc định theo `Thời điểm đăng ký` giảm dần của hồ sơ gốc.<br>- Mặc định hiển thị 10 hồ sơ gốc/trang, kèm các dòng con thụt lề bên dưới từng hồ sơ gốc.<br>- Trạng thái có dữ liệu: Hiển thị danh sách các bản ghi kết quả theo cấu trúc các cột quy định.<br>- Trạng thái không có dữ liệu (Empty State): Khi không tìm thấy kết quả phù hợp với điều kiện tìm kiếm, bảng hiển thị duy nhất 01 dòng căn giữa trên toàn bộ chiều rộng bảng (`colspan`), in nghiêng với nội dung: *"Không tìm thấy dữ liệu phù hợp với điều kiện tìm kiếm."* |
