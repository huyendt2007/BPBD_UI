...
| Loại giấy tờ | Enum(String(50)) | Có | Theo hồ sơ tài khoản | - Control UI: Combobox.<br>- Tham chiếu Danh mục Loại giấy tờ pháp lý/thân nhân [DM_10].<br>- Quyền chỉnh sửa: Cho phép sửa khi `Nguồn xác thực = Nội bộ`; khóa chỉ đọc khi `Nguồn xác thực = VNeID` hoặc `VNeID, Nội bộ`.<br>- Ràng buộc: Khi sửa, kiểm tra trùng lặp theo bộ thông tin định danh cá nhân. |
