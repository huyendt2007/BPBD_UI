### 4.1.8. Cập nhật thông tin tài khoản dành cho Khách hàng

#### 4.1.8.1. Mục đích

- Cho phép Khách hàng (Cá nhân và Tổ chức) cập nhật thông tin hồ sơ tài khoản và thiết lập nhu cầu sử dụng dịch vụ sau khi đăng nhập hệ thống.

#### 4.1.8.3. Màn hình Cập nhật thông tin tài khoản

##### 4.1.8.3.1. Màn hình

![Cập nhật thông tin tài khoản](images/UC003_MH01_Cap_nhat_thong_tin_tai_khoan.png)
...
| Nhu cầu sử dụng tài khoản | List(Enum(String(50))) | Không | Theo hồ sơ tài khoản | - Control UI: Checkbox (Cho phép chọn nhiều).<br>- Giá trị gồm:<br>+ `Tài khoản đăng ký`<br>+ `Tài khoản tra cứu`<br>- Quyền chỉnh sửa: Luôn cho phép chỉnh sửa. |
...
| | | | **TH Hợp lệ**: Hệ thống lưu thông tin cập nhật vào CSDL, tự động tính lại `Phân loại khách hàng`, tự động cập nhật gán tài khoản vào Nhóm người dùng (User Group) tương ứng theo quy tắc:<br>+ Nếu chọn `Tài khoản đăng ký` và `Loại khách hàng = Cá nhân`: Gán vào nhóm **Đăng ký cá nhân**.<br>+ Nếu chọn `Tài khoản đăng ký` và `Loại khách hàng = Tổ chức`: Gán vào nhóm **Đăng ký tổ chức**.<br>+ Nếu chọn `Tài khoản tra cứu`: Gán vào nhóm **Tài khoản tra cứu**.<br>+ Nếu chọn cả `Tài khoản đăng ký` và `Tài khoản tra cứu`: Gán đồng thời vào cả hai nhóm người dùng tương ứng.<br>Ghi Audit Log, hiển thị thông báo thành công [MSG-SUC-ACC-001], cập nhật lại tên/email hiển thị trên Header người dùng và quay về màn hình Xem chi tiết thông tin tài khoản. |
| 2 | Hủy | Button | Đóng form cập nhật, không lưu bất kỳ thay đổi nào và quay về màn hình Xem chi tiết thông tin tài khoản. |
