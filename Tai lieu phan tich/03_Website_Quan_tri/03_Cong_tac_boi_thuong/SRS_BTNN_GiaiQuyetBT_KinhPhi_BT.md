...
- **Lập đề nghị**: Tạo mới đề xuất tạm ứng kinh phí hoặc đề xuất cấp kinh phí bồi thường từ vụ việc yêu cầu bồi thường gốc; hoặc chủ động hoàn thiện đề nghị từ bản ghi "Đề nghị tạm ứng" được hệ thống tự động khởi tạo ở trạng thái `Chờ lập đề nghị` khi hồ sơ yêu cầu bồi thường có yêu cầu tạm ứng được xác nhận thụ lý hợp lệ.
...
```mermaid
flowchart TD
    A0[Hồ sơ YCBT được Thụ lý hợp lệ & có Yêu cầu tạm ứng] -->|Tự động sinh bản ghi| A1[Đề xuất Đề nghị tạm ứng - Trạng thái: Chờ lập đề nghị]
    A02[Hồ sơ YCBT Đã có Bản án/QĐ Tòa án lưu hợp lệ chuyển Chờ thực thi] -->|Tự động sinh bản ghi| A2[Đề nghị cấp kinh phí bồi thường - Trạng thái: Chờ lập đề nghị]
    A1 --> A[MH01 - Danh sách Đề nghị kinh phí bồi thường]
    A2 --> A
    A --> B[Tìm kiếm / Xóa bộ lọc / Phân trang / Kết xuất Excel]
...
| Trạng thái | Enum(String(50)) | - | Theo dữ liệu | Control UI: Badge trạng thái.<br>Gồm:<br>+ Chờ lập đề nghị (áp dụng cho: (1) các bản ghi Đề nghị tạm ứng được hệ thống tự động khởi tạo khi hồ sơ YCBT có yêu cầu tạm ứng kinh phí được xác nhận thụ lý; (2) các bản ghi Đề nghị cấp kinh phí bồi thường được hệ thống tự động khởi tạo khi hồ sơ Đã có Bản án/Quyết định của Tòa án chuyển sang Chờ thực thi; hoặc (3) bản ghi tờ trình lưu nháp)<br>+ Chờ duyệt<br>+ Chờ chi trả<br>+ Hoàn thành<br>+ Sung quỹ nhà nước<br>+ Bị từ chối |
