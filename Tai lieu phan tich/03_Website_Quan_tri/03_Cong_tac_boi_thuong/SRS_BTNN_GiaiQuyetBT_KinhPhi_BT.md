...
| 8 | Lập đề nghị | Icon button (Dòng) | Mở màn hình **MH02 - Màn hình Lập/Cập nhật đề nghị cấp kinh phí**, tự động nạp sẵn mã vụ việc gốc, thông tin người yêu cầu bồi thường và các khoản thiệt hại đề nghị tạm ứng từ chính bản ghi `Chờ lập đề nghị` (được hệ thống tự động khởi tạo khi hồ sơ YCBT có yêu cầu tạm ứng được xác nhận thụ lý), ẩn nút Tìm kiếm và khóa chỉ đọc trường `Mã vụ việc gốc` để Cán bộ thụ lý/giải quyết chủ động hoàn thiện tờ trình. |
