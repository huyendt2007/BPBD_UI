...
\- Các trạng thái Quyết định giải quyết bồi thường tham chiếu danh mục [DM_30].

\- Loại quyết định tham chiếu danh mục [DM_31], gồm: `Quyết định giải quyết bồi thường`, `Quyết định hủy quyết định giải quyết bồi thường`, `Quyết định sửa chữa, bổ sung quyết định giải quyết bồi thường`.
...
| Loại quyết định | Enum(String(100)) | Không | Tất cả | Danh sách giá trị theo [DM_31], giao diện hiển thị: `Tất cả`, `Quyết định giải quyết bồi thường`, `Quyết định hủy quyết định giải quyết bồi thường`, `Quyết định sửa chữa, bổ sung quyết định giải quyết bồi thường`. |
...
| Trạng thái quyết định | Enum(String(50)) | Không | Tất cả | Danh sách giá trị theo [DM_30], giao diện hiển thị:<br>- Tất cả<br>- Lưu nháp<br>- Chờ ký<br>- Bị từ chối<br>- Đã ký<br>- Đã ban hành<br>- Đã hủy |
| Hình thức ban hành | Enum(String(50)) | Không | Tất cả | Gồm: `Tất cả`, `Ký số trên hệ thống`, `Ký bên ngoài`. |
| Đơn vị ban hành | Enum(String(255)) | Không | Tất cả | Lọc theo đơn vị có thẩm quyền ban hành quyết định; giá trị lấy từ danh mục đơn vị. |
...
| Xóa bộ lọc | - | Không | Hiển thị | Chi tiết nghiệp vụ xem ở bảng Chức năng trên màn hình. |
| Tìm kiếm | - | Không | Hiển thị | Chi tiết nghiệp vụ xem ở bảng Chức năng trên màn hình. |
| Tạo mới Quyết định | - | Không | Hiển thị với Cán bộ xử lý | Chi tiết nghiệp vụ xem ở bảng Chức năng trên màn hình. |
| Kết xuất Excel | - | Không | Hiển thị | Chi tiết nghiệp vụ xem ở bảng Chức năng trên màn hình. |
| Bảng danh sách quyết định | - | Không | Theo dữ liệu hệ thống | Hiển thị danh sách quyết định theo bộ lọc và vai trò người dùng. Click trực tiếp vào dòng dữ liệu mở **4.3.3.3.5. MH03 - Màn hình Chi tiết Quyết định giải quyết bồi thường**, trừ khi click vào icon thao tác hoặc liên kết Mã vụ việc.<br>- Trạng thái có dữ liệu: Hiển thị danh sách các bản ghi kết quả theo cấu trúc các cột quy định.<br>- Trạng thái không có dữ liệu (Empty State): Khi không tìm thấy kết quả phù hợp với điều kiện tìm kiếm, bảng hiển thị duy nhất 01 dòng căn giữa trên toàn bộ chiều rộng bảng (`colspan`), in nghiêng với nội dung: *"Không tìm thấy dữ liệu phù hợp với điều kiện tìm kiếm."* |
| Cột: STT | Integer(10) | Không | Tự tăng | Hiển thị số thứ tự bản ghi trong danh sách. |
| Cột: Số quyết định | String(50) | Không | Theo dữ liệu | Hiển thị số quyết định. Trường hợp chưa được cấp số, hiển thị giá trị tương ứng của dữ liệu dự thảo. |
| Cột: Ngày ban hành | Date | Không | Theo dữ liệu | Hiển thị ngày ban hành nếu đã có dữ liệu; trường hợp chưa ban hành hiển thị trạng thái dữ liệu tương ứng. |
| Cột: Ngày hiệu lực | Date | Không | Theo dữ liệu | Hiển thị ngày có hiệu lực của quyết định. |
| Cột: Loại quyết định | Enum(String(100)) | Không | Theo dữ liệu | Hiển thị loại quyết định theo [DM_31]. |
| Cột: Người ký | String(100) | Không | Theo dữ liệu | Hiển thị ở góc nhìn Cán bộ xử lý. |
| Cột: Cán bộ xử lý | String(100) | Không | Theo dữ liệu | Hiển thị ở góc nhìn Lãnh đạo phê duyệt thay cho cột Người ký. |
| Cột: Hình thức ban hành | Enum(String(50)) | Không | Theo dữ liệu | Hiển thị `Ký số trên hệ thống` hoặc `Ký bên ngoài`. |
| Cột: Đơn vị ban hành | String(255) | Không | Theo dữ liệu | Hiển thị đơn vị sở hữu sổ văn bản và có thẩm quyền ban hành quyết định. |
| Cột: Trích yếu quyết định | String(500) | Không | Theo dữ liệu | Hiển thị trích yếu quyết định giải quyết bồi thường. |
| Cột: Mã vụ việc | String(50) | Không | Theo dữ liệu | Hiển thị dạng Link. Cho phép mở **4.3.3.3.8. MH06 - Popup Vụ việc yêu cầu bồi thường liên kết** trong cùng tab/màn làm việc theo luồng liên kết của hệ thống. |
| Cột: Tên vụ việc | String(255) | Không | Theo dữ liệu | Hiển thị tên vụ việc bồi thường liên kết. |
| Cột: Trạng thái | Enum(String(50)) | Không | Theo dữ liệu | Hiển thị dạng Badge. Hiển thị trạng thái quyết định theo [DM_30]. |
| Cột: Thao tác | - | Không | Theo vai trò/trạng thái | Không hiển thị row click xem chi tiết; người dùng xem chi tiết bằng cách click vào dòng dữ liệu. Với Cán bộ xử lý hiển thị các icon hợp lệ theo trạng thái: `Sửa`, `Xóa`, `Hủy quyết định`, `Sửa chữa, bổ sung`. Với Lãnh đạo phê duyệt hiển thị các icon: `Phê duyệt`, `Từ chối`. Các thao tác không hợp lệ theo trạng thái hiển thị dạng mờ/không cho bấm. |
| Phân trang | String(255) | Không | 5 bản ghi/trang | Cho phép chọn số bản ghi/trang: 5 hoặc 10. |
...
| 4 | Tìm kiếm | Button | TH1 (Khoảng ngày không hợp lệ): Nếu "Ban hành: Từ ngày" lớn hơn "Ban hành: Đến ngày", vi phạm [BR-VAL-007], hiển thị cảnh báo lỗi [MSG-ERR-VAL-007] và không thực hiện tìm kiếm.<br>- **TH Không có dữ liệu trả về**:<br>+ Bảng kết quả: Hiển thị dòng thông báo rỗng *"Không tìm thấy dữ liệu phù hợp với điều kiện tìm kiếm."* ở giữa bảng.<br>+ Thanh phân trang (Pagination): Dòng số lượng hiển thị *"Hiển thị 0-0 của 0 bản ghi"* (hoặc *"Hiển thị 0-0 của 0 yêu cầu"*); các nút điều hướng trang (`&#124;&lt;&lt;`, `&lt;`, các số trang, `&gt;`, `&gt;&gt;&#124;`) ở trạng thái ẩn hoặc khóa mờ (Disabled).<br>+ Nút "Kết xuất Excel" (nếu màn hình có nút này): Thiết lập ở trạng thái khóa mờ (Disabled) với thuộc tính `style="opacity: 0.35; pointer-events: none; cursor: not-allowed;"` kèm tooltip: *"Không có dữ liệu để kết xuất Excel"*. |
|  |  |  | TH Hợp lệ: Hệ thống tìm kiếm gần đúng theo "Số quyết định bồi thường", "Mã vụ việc", "Tên vụ việc", "Người ký quyết định"; lọc chính xác theo "Loại quyết định", "Trạng thái quyết định" và khoảng ngày ban hành. Nếu tiêu chí rỗng, hiển thị danh sách mặc định theo vai trò hiện tại. |
| 5 | Tạo mới Quyết định | Button | Mở **4.3.3.3.4. MH02 - Màn hình Trình ký/Cập nhật Quyết định giải quyết bồi thường** ở chế độ tạo mới để Cán bộ lập dự thảo quyết định. |
...
| 7 | Click dòng dữ liệu | Row click | Mở **4.3.3.3.5. MH03 - Màn hình Chi tiết Quyết định giải quyết bồi thường** tương ứng với bản ghi được chọn. Nếu click vào icon thao tác hoặc liên kết `Mã vụ việc`, hệ thống thực hiện chức năng của icon/liên kết và không kích hoạt row click. |
...
|  |  |  | TH Hợp lệ: Mở **4.3.3.3.4. MH02 - Màn hình Trình ký/Cập nhật Quyết định giải quyết bồi thường** ở chế độ cập nhật với dữ liệu đã lưu của bản ghi được chọn. |
...
|  |  |  | TH Hợp lệ: Mở **4.3.3.3.7. MH05 - Popup Yêu cầu hiệu chỉnh dự thảo Quyết định** để Lãnh đạo nhập lý do từ chối. |
| 12 | Mã vụ việc | Link | Mở **4.3.3.3.8. MH06 - Popup Vụ việc yêu cầu bồi thường liên kết** trong cùng tab/màn làm việc; khi đóng chi tiết vụ việc gốc, quay lại màn Quyết định giải quyết bồi thường. |
...
|  |  |  | TH Hợp lệ: Mở **4.3.3.3.10. MH08 - Màn hình Hủy/Sửa chữa, bổ sung Quyết định giải quyết bồi thường** ở chế độ `Hủy quyết định giải quyết bồi thường`; hệ thống kế thừa thông tin quyết định gốc để lập văn bản theo `Mẫu 11/BTNN`. |
...
|  |  |  | TH Hợp lệ: Mở **4.3.3.3.10. MH08 - Màn hình Hủy/Sửa chữa, bổ sung Quyết định giải quyết bồi thường** ở chế độ `Sửa chữa, bổ sung quyết định giải quyết bồi thường`; hệ thống kế thừa thông tin quyết định gốc để lập văn bản theo `Mẫu 12/BTNN`. |
...
| Tìm kiếm nâng cao | - | Không | Hiển thị cạnh trường Mã vụ việc | Mở popup chuẩn **4.3.3.1.8. Popup chuẩn Tìm kiếm vụ việc/hồ sơ gốc liên quan** với tiêu đề `Tìm kiếm vụ việc yêu cầu bồi thường đủ điều kiện lập quyết định`; nguồn dữ liệu chỉ gồm các vụ việc đủ điều kiện lập Quyết định giải quyết bồi thường. |
| Cơ quan cấp trên | String(255) | Không | BỘ TƯ PHÁP | Chỉ đọc. Trường hệ thống tự điền, không cho phép chỉnh sửa. |
...
| Lãnh đạo ký ban hành | Enum(String(255)) | Có khi `Hình thức ban hành` = `Ký số trên hệ thống` | Chọn lãnh đạo ký | \- Control UI: Combobox có ô tìm kiếm.<br>- Bắt buộc chọn trước khi trình ký.<br>- Chỉ hiển thị lãnh đạo còn hiệu lực, thuộc `Đơn vị ban hành` hoặc phạm vi được ủy quyền ký cho đơn vị ban hành.<br>- Không lấy danh sách lãnh đạo theo `Đơn vị nhập liệu` nếu cán bộ đang nhập thay. |
| Số văn bản | String(50) | Có điều kiện | Trống | Với `Ký số trên hệ thống`: chỉ đọc, hệ thống cấp số từ `Sổ văn bản áp dụng` khi lãnh đạo phê duyệt/ký thành công. Với `Ký bên ngoài`: cán bộ nhập số quyết định đã ký ngoài; hệ thống kiểm tra trùng số trong cùng sổ/năm và cảnh báo nếu số không liền kề số hiện tại của sổ. |
...
| Địa điểm ban hành | String(100) | Không | Hà Nội | Chỉ đọc. Trường hệ thống tự điền theo giao diện. |
| Mã vụ việc | String(50) | Có | Theo vụ việc được chọn | Chỉ đọc. Tự động điền sau khi chọn vụ việc YCBT. |
| Tên vụ việc | String(255) | Không | Theo vụ việc được chọn | Chỉ đọc. Tự động điền sau khi chọn vụ việc YCBT. |
| Người yêu cầu bồi thường | String(100) | Không | Theo vụ việc được chọn | Chỉ đọc. Tự động điền sau khi chọn vụ việc YCBT. |
| Tỉnh/TP | Enum(String(100)) | Không | Theo vụ việc được chọn | Chỉ đọc. Tự động điền tỉnh/thành phố sau khi chọn vụ việc YCBT. |
| Địa chỉ chi tiết | String(500) | Không | Theo vụ việc được chọn | Chỉ đọc. Tự động điền địa chỉ chi tiết sau khi chọn vụ việc YCBT. |
| Cán bộ/Người thi hành công vụ gây thiệt hại | String(100) | Không | Theo vụ việc được chọn | Chỉ đọc. Tự động điền sau khi chọn vụ việc YCBT. |
| Căn cứ văn bản | String(500) | Không | Theo vụ việc được chọn | Chỉ đọc. Tự động điền văn bản/căn cứ pháp lý từ vụ việc YCBT. |
| Cơ quan quản lý người thi hành công vụ | String(255) | Không | Sở Tư pháp Thành phố Hà Nội | Chỉ đọc. Trường hệ thống tự điền theo giao diện. |
| Ngày thương lượng | Date | Không | Theo vụ việc được chọn | Tự động điền ngày thương lượng từ vụ việc YCBT. |
| Phương thức chi trả | String(255) | Không | chuyển khoản vào tài khoản cá nhân của người yêu cầu | Chỉ đọc. Tự động điền theo dữ liệu vụ việc. Nếu chuẩn hóa danh mục, tham chiếu [DM_28]. |
...
| Nhóm số tiền thiệt hại | Decimal(18,0) | Không | Theo hồ sơ được chọn | Gồm các cấu phần theo [DM_27]:<br>- Thiệt hại do tài sản bị xâm phạm<br>- Thiệt hại do thu nhập thực tế bị mất hoặc bị giảm sút<br>- Thiệt hại về vật chất do người bị thiệt hại chết<br>- Thiệt hại về vật chất do sức khỏe bị xâm phạm<br>- Thiệt hại về tinh thần<br>- Các chi phí khác được bồi thường |
...
| Cột: STT | Integer(10) | Không | Tự tăng | Số thứ tự dòng tài liệu. |
| Cột: Tên văn bản / Căn cứ | String(500) | Không | Trống/Theo dữ liệu | Nhập tên văn bản hoặc căn cứ pháp lý. |
| Cột: File đính kèm | File | Không | Trống/Theo dữ liệu | Cho phép chọn tệp PDF theo [BR-FILE-010]. |
| Cột: Thao tác | String(255) | Không | Theo dòng | Chỉ đọc. Gồm:<br>- Chọn tệp<br>- Xem file<br>- Xóa dòng<br>Với "Xem file": Cho phép xem file tại một tab riêng. |
...
| Cột: Thời gian | Datetime | Không | Theo dữ liệu | Chỉ đọc. Hiển thị thời điểm phát sinh lịch sử. |
| Cột: Người thực hiện | String(100) | Không | Theo dữ liệu | Hiển thị người thực hiện thao tác. |
| Cột: Thao tác | String(100) | Không | Theo dữ liệu | Hiển thị thao tác: Trình ký duyệt, Từ chối phê duyệt, Phê duyệt. |
| Cột: Nội dung / Lý do | Text(2000) | Không | Theo dữ liệu | Hiển thị nội dung xử lý hoặc lý do từ chối. |
| Khung xem trước trực quan | String(255) | Không | Dự thảo quyết định | Hiển thị bản dựng trực quan của quyết định theo dữ liệu form hiện tại. |
...
| 2 | Tìm kiếm | Button | TH1 (Chưa nhập Mã vụ việc): Vi phạm quy tắc [BR-VAL-001]. Hệ thống tô viền đỏ ô trống đầu tiên và hiển thị cảnh báo lỗi [MSG-ERR-VAL-001] màu đỏ. Không tự động điền dữ liệu.<br>- **TH Không có dữ liệu trả về**:<br>+ Bảng kết quả: Hiển thị dòng thông báo rỗng *"Không tìm thấy dữ liệu phù hợp với điều kiện tìm kiếm."* ở giữa bảng.<br>+ Thanh phân trang (Pagination): Dòng số lượng hiển thị *"Hiển thị 0-0 của 0 bản ghi"* (hoặc *"Hiển thị 0-0 của 0 yêu cầu"*); các nút điều hướng trang (`&#124;&lt;&lt;`, `&lt;`, các số trang, `&gt;`, `&gt;&gt;&#124;`) ở trạng thái ẩn hoặc khóa mờ (Disabled).<br>+ Nút "Kết xuất Excel" (nếu màn hình có nút này): Thiết lập ở trạng thái khóa mờ (Disabled) với thuộc tính `style="opacity: 0.35; pointer-events: none; cursor: not-allowed;"` kèm tooltip: *"Không có dữ liệu để kết xuất Excel"*. |
|  |  |  | TH2 (Có nhập Mã vụ việc): Hệ thống mở popup chuẩn **4.3.3.1.8** giống thao tác `Tìm kiếm nâng cao`, tự động điền sẵn giá trị Mã vụ việc vào trường tìm kiếm của popup và hiển thị `Bảng kết quả tìm kiếm` để người dùng chọn vụ việc phù hợp. |
|  |  |  | TH3 (Không tìm thấy vụ việc phù hợp): Trong popup chuẩn **4.3.3.1.8**, hệ thống hiển thị `Bảng kết quả tìm kiếm` trống; phần thân bảng hiển thị thông báo theo MessageList, không tự động điền dữ liệu vào form. |
|  |  |  | TH4 (Người dùng chọn vụ việc): Hệ thống tự động điền các trường thông tin liên quan từ vụ việc YCBT đã hoàn thành thương lượng, tính toán số tiền còn lại sau tạm ứng, cập nhật khung xem trước quyết định và đóng popup. |
| 3 | Tìm kiếm nâng cao | Button | Mở popup chuẩn **4.3.3.1.8** với nguồn dữ liệu vụ việc đủ điều kiện lập quyết định. Người dùng tìm kiếm theo các tiêu chí trên popup và chọn vụ việc phù hợp để tự động điền dữ liệu về form.<br>- **TH Không có dữ liệu trả về**:<br>+ Bảng kết quả: Hiển thị dòng thông báo rỗng *"Không tìm thấy dữ liệu phù hợp với điều kiện tìm kiếm."* ở giữa bảng.<br>+ Thanh phân trang (Pagination): Dòng số lượng hiển thị *"Hiển thị 0-0 của 0 bản ghi"* (hoặc *"Hiển thị 0-0 của 0 yêu cầu"*); các nút điều hướng trang (`&#124;&lt;&lt;`, `&lt;`, các số trang, `&gt;`, `&gt;&gt;&#124;`) ở trạng thái ẩn hoặc khóa mờ (Disabled).<br>+ Nút "Kết xuất Excel" (nếu màn hình có nút này): Thiết lập ở trạng thái khóa mờ (Disabled) với thuộc tính `style="opacity: 0.35; pointer-events: none; cursor: not-allowed;"` kèm tooltip: *"Không có dữ liệu để kết xuất Excel"*. |
...
| 8 | Xem Trước Quyết định | Button | TH1 (Chưa có dữ liệu hồ sơ YCBT): Vi phạm quy tắc [BR-VAL-001]. Hệ thống hiển thị cảnh báo lỗi [MSG-ERR-VAL-001] và không mở **4.3.3.3.6. MH04 - Popup Xem trước Quyết định Giải quyết yêu cầu bồi thường**. |
|  |  |  | TH Hợp lệ: Mở **4.3.3.3.6. MH04 - Popup Xem trước Quyết định Giải quyết yêu cầu bồi thường** với nội dung quyết định được sinh từ dữ liệu đang có trên form. |
...
|  |  |  | TH Hợp lệ: Hệ thống lưu/cập nhật quyết định ở trạng thái "Lưu nháp", hiển thị [MSG-SUC-SYS-001] hoặc [MSG-SUC-SYS-002], cập nhật danh sách và mở **4.3.3.3.5. MH03 - Màn hình Chi tiết Quyết định giải quyết bồi thường** của bản ghi vừa lưu. |
...
|  |  |  | TH Hợp lệ: Hệ thống lưu quyết định ở trạng thái "Chờ ký", ghi nhận Lãnh đạo ký ban hành đã chọn thuộc `Đơn vị ban hành`, chuyển quyết định đến đúng Lãnh đạo đã chọn, ghi nhận lịch sử "Trình ký duyệt", cập nhật danh sách, mở **4.3.3.3.5. MH03 - Màn hình Chi tiết Quyết định giải quyết bồi thường** của bản ghi vừa trình ký và hiển thị [MSG-SUC-BTNN-QD-001]. |
...
| Đóng | - | Không | Hiển thị | Chi tiết nghiệp vụ xem ở bảng Chức năng trên màn hình. |
| Trạng thái quyết định | Enum(String(50)) | Không | Theo dữ liệu | Hiển thị trạng thái theo [DM_30]. |
...
| Cột: STT | Integer(10) | Không | Tự tăng | Số thứ tự văn bản/tài liệu. |
| Cột: Tên văn bản / Căn cứ pháp lý | String(500) | Không | Theo dữ liệu | Hiển thị tên văn bản/căn cứ. |
| Cột: Ngày ban hành/Lập | Date | Không | Theo dữ liệu | Hiển thị ngày ban hành/lập văn bản căn cứ. |
| Cột: Thao tác | - | Không | Theo dữ liệu | Gồm thao tác xem file/tài liệu. Với "Xem file": Cho phép xem file tại một tab riêng. |
...
| 4 | Xem Trước Quyết định | Button/Link | Mở **4.3.3.3.6. MH04 - Popup Xem trước Quyết định Giải quyết yêu cầu bồi thường** theo dữ liệu hiện tại của bản ghi. |
| 5 | Xem file | Link | Cho phép xem file tại một tab riêng. |
| 6 | Từ chối | Button | Mở **4.3.3.3.7. MH05 - Popup Yêu cầu hiệu chỉnh dự thảo Quyết định** để Lãnh đạo nhập lý do từ chối phê duyệt. |
...
##### 4.3.3.3.6. MH04 - Popup Xem trước Quyết định Giải quyết yêu cầu bồi thường
...
| Trường thông tin | Kiểu dữ liệu | Bắt buộc | Mặc định | Mô tả |
| :--- | :--- | :--- | :--- | :--- |
| Tiêu đề popup | String(200) | Không | Xem trước Quyết định Giải quyết yêu cầu bồi thường | Hiển thị tiêu đề popup xem trước. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Đóng | Button/Icon | Đóng popup xem trước quyết định và quay lại màn hình trước đó. |
...
##### 4.3.3.3.8. MH06 - Popup Hồ sơ yêu cầu bồi thường liên kết
...
| Trường thông tin | Kiểu dữ liệu | Bắt buộc | Mặc định | Mô tả |
| :--- | :--- | :--- | :--- | :--- |
| Tiêu đề popup | String(200) | Không | Vụ việc Yêu cầu bồi thường liên kết: [Mã vụ việc] | Hiển thị mã vụ việc YCBT được mở từ liên kết Mã vụ việc. |
...
| Lĩnh vực phát sinh | Enum(String(100)) | Không | Theo dữ liệu | Hiển thị lĩnh vực phát sinh thiệt hại, tham chiếu [DM_22] khi chuẩn hóa dữ liệu. |
| Họ tên người yêu cầu | String(100) | Không | Theo dữ liệu | Hiển thị người yêu cầu bồi thường. |
| Tỉnh/TP | Enum(String(100)) | Không | Theo dữ liệu | Hiển thị tỉnh/thành phố của người yêu cầu hoặc địa bàn phát sinh vụ việc. |
| Địa chỉ chi tiết | Text(1000) | Không | Theo dữ liệu | Hiển thị địa chỉ chi tiết của người yêu cầu/vụ việc. |
...
| Trạng thái vụ việc | Enum(String(50)) | Không | Chờ ban hành QĐ | Hiển thị dạng Badge. Hiển thị trạng thái hồ sơ YCBT theo [DM_24]. |
...
| 2 | Đóng | Button/Icon | Đóng popup hồ sơ yêu cầu bồi thường liên kết và quay lại màn hình đang mở trước đó. |
...
| Lãnh đạo ký ban hành | Enum(String(255)) | Có khi `Hình thức ban hành` = `Ký số trên hệ thống` | Trống | Combobox có ô tìm kiếm, chỉ hiển thị lãnh đạo còn hiệu lực, thuộc `Đơn vị ban hành` hoặc phạm vi được ủy quyền ký cho đơn vị ban hành. |
...
\- Liên kết Mã vụ việc trên danh sách Quyết định mở **4.3.3.3.8. MH06 - Popup Vụ việc yêu cầu bồi thường liên kết** trong cùng tab/màn làm việc, đảm bảo khi quay lại vẫn trở về đúng màn Quyết định giải quyết bồi thường.
