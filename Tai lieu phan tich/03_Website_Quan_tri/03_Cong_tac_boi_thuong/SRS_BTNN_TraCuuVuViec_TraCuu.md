...
| 4 | Kết xuất Excel | Button | Bố trí tại thanh tiêu đề Bảng kết quả tìm kiếm (phía trên bảng dữ liệu, cùng hàng với tiêu đề bảng và số lượng bản ghi), tách biệt hoàn toàn khỏi cụm nút chức năng của bộ lọc ("Xóa bộ lọc", "Tìm kiếm"). Hệ thống kết xuất danh sách kết quả hiện hành của tab đang chọn theo đúng tiêu chí lọc và sắp xếp hiện tại. Nếu danh sách rỗng, áp dụng [BR-EXP-040] và không tải file. |
