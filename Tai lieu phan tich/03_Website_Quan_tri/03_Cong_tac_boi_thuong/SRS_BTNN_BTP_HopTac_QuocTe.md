...
\- Quốc gia đối tác tham chiếu danh mục [DM_09]. Đơn vị chủ trì tham chiếu Danh mục các đơn vị trên hệ thống `[DM_DON_VI]`.
...
| Quốc gia đối tác | Enum(String(100)) | Không | Tất cả | Tham chiếu [DM_09]. Giá trị lọc gồm `Tất cả` và các giá trị thuộc [DM_09]. |
...
| Cột: Quốc gia đối tác | Enum(String(100)) | Không | Theo dữ liệu hệ thống | Chỉ đọc. Tham chiếu [DM_09]. |
...
| 3 | Thêm mới | Button | Hệ thống mở **4.3.3.16.4. MH02 - Màn hình Thêm mới/Chỉnh sửa hoạt động hợp tác quốc tế BTNN** ở chế độ thêm mới. |
| 4 | Chỉnh sửa | Icon button | Hệ thống mở **4.3.3.16.4. MH02** ở chế độ chỉnh sửa. |
| 5 | Xóa | Icon button | Hệ thống mở **4.3.3.16.5. Popup Xác nhận** với nội dung [MSG-CFM-SYS-001]. Nếu xác nhận, hệ thống xóa vĩnh viễn bản ghi khỏi hệ thống và hiển thị [MSG-SUC-SYS-002]. |
| 6 | Click dòng dữ liệu | Row click | Hệ thống mở **4.3.3.16.4. MH02** ở chế độ chỉ xem. |
...
| Quốc gia đối tác | Enum(String(100)) | Có | Trống | Tham chiếu [DM_09]. Áp dụng rule bắt buộc [BR-VAL-001]. |
...
| Đơn vị chủ trì | Enum(String(255)) | Có | Trống | Giá trị lấy từ Danh mục các đơn vị trên hệ thống `[DM_DON_VI]`. Cho phép tìm kiếm nhanh theo `Mã đơn vị` hoặc `Tên đơn vị`; áp dụng tìm gần đúng. Áp dụng rule bắt buộc [BR-VAL-001]. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Hủy bỏ | Button | Hệ thống đóng màn hình, không lưu dữ liệu và quay lại **4.3.3.16.3. MH01**. |
