...
flowchart TD
    ...
    V -.->|"Quyết định GQBT bị hủy theo Mẫu 11/BTNN"| Y3
...
| 13 | Thụ lý hồ sơ | Icon button/Button | Hệ thống mở [Popup Thụ lý hồ sơ và Cử người giải quyết bồi thường](#43318-popup-thụ-lý-hồ-sơ-và-cử-người-giải-quyết-bồi-thường). Sau khi xác nhận thụ lý hợp lệ: lưu thông tin cử người giải quyết, chuyển trạng thái giải quyết của hồ sơ sang `Đang xác minh thiệt hại`; đồng thời nếu hồ sơ có Yêu cầu tạm ứng kinh phí: Hệ thống kiểm tra trùng lặp trên Module Quản lý kinh phí bồi thường (nếu vụ việc chưa tồn tại Đề nghị tạm ứng hoặc Đề nghị cấp kinh phí bồi thường ở các trạng thái có hiệu lực) thì tự động khởi tạo 01 bản ghi với trạng thái `Chờ lập đề nghị` (Loại đề nghị: `Đề nghị tạm ứng`) để Cán bộ thụ lý/giải quyết chủ động thực hiện; trường hợp đã có đề nghị có hiệu lực thì bỏ qua không khởi tạo trùng lặp. |
...
| Địa chỉ chi tiết người nhận | Text(1000) | Có khi hiển thị | Trống | Control UI: Textarea <br>- Nhập địa chỉ cư trú hoặc địa chỉ liên hệ của người nhận tiền.<br>- Áp dụng quy tắc bắt buộc [BR-VAL-001]. |
| Phương thức chi trả tiền bồi thường | Enum(String(100)) | Có khi hiển thị | `Chi trả trực tiếp bằng tiền mặt` | Control UI: Combobox.<br>Danh sách giá trị lựa chọn cố định gồm:<br>- `Chi trả trực tiếp bằng tiền mặt`<br>- `Chi trả qua chuyển khoản` |
...
|  |  |  | **TH10 - Hợp lệ (Hồ sơ Đã có Bản án/Quyết định của Tòa án)**: Hệ thống lưu toàn bộ thông tin bản án và mức bồi thường đã nhập; hồ sơ chuyển sang trạng thái `Chờ thực thi`, đồng thời hệ thống kiểm tra trùng lặp tại Module Quản lý kinh phí bồi thường: Nếu vụ việc chưa tồn tại Đề nghị cấp kinh phí bồi thường ở các trạng thái có hiệu lực (`Chờ lập đề nghị`, `Chờ duyệt`, `Chờ chi trả`, `Chờ thu hồi`, `Hoàn thành`, `Sung quỹ nhà nước`), hệ thống tự động tạo 01 bản ghi với trạng thái `Chờ lập đề nghị` (Loại đề nghị: `Đề nghị cấp kinh phí bồi thường`) theo thông tin số tiền đã nhập ở hồ sơ (không qua các bước Chờ kiểm tra, Thụ lý, Xác minh thiệt hại, Thương lượng hay Ban hành Quyết định bồi thường); trường hợp đã có đề nghị cấp kinh phí có hiệu lực thì bỏ qua không khởi tạo trùng lặp. |
...
<a id="mh03-mo-ta-thong-tin-xu-ly-ho-so"></a>
...
| *Khối Thông tin người nhận tiền* | String(100) | - | Theo dữ liệu | **Khối thông tin người nhận tiền tạm ứng/bồi thường ở chế độ chỉ đọc.**<br>- *Điều kiện hiển thị*: Chỉ hiển thị khi có dữ liệu tạm ứng kinh phí hoặc khi phát sinh chi trả tiền bồi thường.<br>- *Phạm vi khối*: Gồm các trường từ "Họ và tên người nhận" đến "Chi nhánh ngân hàng". |
...
| *TH3: Quyết định giải quyết bồi thường đã bị hủy* | Object | - | Ẩn nếu không có | Control UI: Alert Box màu đỏ đặt phía trên khối thông tin Quyết định.<br>- Chỉ hiển thị khi Quyết định gắn với hồ sơ đã ở trạng thái `Đã hủy`.<br>- Nội dung hiển thị chỉ đọc gồm: Số và Ngày Quyết định hủy (dạng liên kết mở Chi tiết Quyết định hủy), Lý do hủy quyết định, Người ký và Ngày ban hành Quyết định hủy.<br>- Hệ thống **giữ nguyên toàn bộ thông tin và lịch sử của Quyết định gốc** bên dưới ở chế độ chỉ đọc, không xóa và không ghi đè, để phục vụ đối chiếu và tra cứu về sau.<br>- Đồng thời hồ sơ vụ việc chuyển sang trạng thái `Đình chỉ giải quyết` theo quy tắc mô tả tại chức năng `Ban hành QĐ` của MH05 - Màn hình Hủy/Sửa chữa, bổ sung Quyết định giải quyết bồi thường. |
...
| Tab nghiệp vụ | Enum(String(50)) | - | `Thông tin Hồ sơ yêu cầu` | Control UI: Tab navigation (Chỉ đọc), kế thừa đúng 03 tab và điều kiện hiển thị đã đặc tả tại [MH03 - Màn hình Cập nhật kết quả xử lý hồ sơ yêu cầu bồi thường](#mh03-mo-ta-thong-tin-xu-ly-ho-so). |
| **Tab Thông tin Hồ sơ yêu cầu** | String(100) | - | Active | Kế thừa nguyên trạng toàn bộ trường thông tin từ "Mã vụ việc" đến "Bảng tài liệu đính kèm hồ sơ" đã đặc tả tại [MH03 - Màn hình Cập nhật kết quả xử lý hồ sơ yêu cầu bồi thường](#mh03-mo-ta-thong-tin-xu-ly-ho-so), hiển thị Chỉ đọc. |
...
| 9 | Thụ lý | Button | - **Điều kiện hiển thị**: Chỉ hiển thị khi hồ sơ ở trạng thái `Chờ thụ lý`.<br>- **Luồng xử lý**: Khi người dùng click nút, hệ thống mở [Popup Thụ lý hồ sơ và Cử người giải quyết bồi thường](#43318-popup-thụ-lý-hồ-sơ-và-cử-người-giải-quyết-bồi-thường). Sau khi xác nhận thụ lý hợp lệ: hồ sơ chuyển sang trạng thái `Đang xác minh thiệt hại`; đồng thời nếu hồ sơ có yêu cầu tạm ứng kinh phí: Hệ thống kiểm tra trùng lặp trên Module Quản lý kinh phí bồi thường (nếu vụ việc chưa tồn tại Đề nghị tạm ứng hoặc Đề nghị cấp kinh phí bồi thường ở các trạng thái có hiệu lực) thì tự động tạo 01 bản ghi với trạng thái `Chờ lập đề nghị` (Loại đề nghị: `Đề nghị tạm ứng`) để Cán bộ thụ lý/giải quyết chủ động thực hiện; trường hợp đã có đề nghị có hiệu lực thì bỏ qua không tạo trùng lặp.|
...
| Cột: Mã vụ việc | String(50) | - | Theo dữ liệu | Control UI: Text link (HyperLink).<br>- Chỉ đọc. Hiển thị mã vụ việc yêu cầu bồi thường.<br>- Khi người dùng click, hệ thống mở màn hình Xem chi tiết vụ việc yêu cầu bồi thường tương ứng tại một tab trình duyệt mới ở chế độ chỉ xem, không đóng popup đang mở. |
| Cột: Tên vụ việc | String(255) | - | Theo dữ liệu | Control UI: Text.<br>Chỉ đọc. Căn trái. Hiển thị tên vụ việc yêu cầu bồi thường. |
| Cột: Người yêu cầu | String(100) | - | Theo dữ liệu | Control UI: Text.<br>Chỉ đọc. Căn trái. Hiển thị họ và tên người yêu cầu bồi thường. |
| Cột: Lĩnh vực phát sinh thiệt hại | Enum(String(100)) | - | Theo dữ liệu | Control UI: Text.<br>Chỉ đọc. Tham chiếu Danh mục Lĩnh vực phát sinh thiệt hại [DM_22]. |
| Cột: Tỉnh/Thành phố | Enum(String(100)) | - | Theo dữ liệu | Control UI: Text.<br>Chỉ đọc. Hiển thị Tỉnh/Thành phố theo địa chỉ của người yêu cầu bồi thường. |
| Cột: Ngày tiếp nhận | Date | - | Theo dữ liệu | Control UI: Text.<br>Chỉ đọc. Căn giữa. Định dạng `dd/mm/yyyy`. |
| Cột: Trạng thái | Enum(String(100)) | - | Theo dữ liệu | Control UI: Badge trạng thái.<br>Chỉ đọc. Hiển thị trạng thái hiện hành của vụ việc; chỉ các trạng thái hợp lệ để liên kết theo từng Nguồn gọi popup mới được trả về danh sách. |
| Cột: Thao tác | Action button | - | Theo dòng | Control UI: Button `Chọn`.<br>Chỉ cho phép chọn 01 bản ghi trên một lần thao tác. |

###### 4.3.3.1.10.3. Chức năng trên màn hình

| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Button | Khi người dùng click nút, hệ thống kiểm tra điều kiện dữ liệu và thực hiện tìm kiếm trên popup theo các trường hợp bên dưới:<br>- **TH Không nhập tiêu chí nào**: Hệ thống thực hiện tìm kiếm tất cả các bản ghi hợp lệ trong nguồn dữ liệu liên kết, hiển thị kết quả lên bảng và đưa về Trang 1.<br>- **TH Hợp lệ (Có nhập tiêu chí và có dữ liệu phù hợp)**: Hệ thống lọc và hiển thị danh sách các bản ghi thỏa mãn đồng thời các tiêu chí tìm kiếm/lọc đã nhập/chọn trên popup, hiển thị kết quả lên bảng và đưa về Trang 1.<br>- **TH Không có dữ liệu trả về**: Bảng kết quả hiển thị duy nhất 01 dòng căn giữa trên toàn bộ chiều rộng bảng, in nghiêng với nội dung theo MessageList dùng chung [MSG-INF-SYS-001]; thanh phân trang hiển thị *"Hiển thị 0-0 của 0 bản ghi"*, các nút điều hướng trang ở trạng thái khóa mờ (Disabled).<br><br>**Quy tắc xác định phạm vi dữ liệu tìm kiếm và loại trừ tự động theo từng Nguồn gọi popup:**<br>1. *Nguồn 1 (Từ Màn hình Trình ký/Cập nhật Quyết định giải quyết bồi thường)*: Phạm vi dữ liệu chỉ gồm các hồ sơ vụ việc yêu cầu bồi thường có trạng thái `Đang thương lượng` (đã lập Biên bản kết quả thương lượng thành công) hoặc `Chờ ban hành QĐ`.<br>2. *Nguồn 2 (Từ Màn hình Nhập liệu hồ sơ vụ việc mới)*: Phạm vi dữ liệu gồm danh sách các vụ việc yêu cầu bồi thường đã có trên hệ thống thuộc thẩm quyền đơn vị.<br>3. *Nguồn 3 (Từ Màn hình Hủy/Sửa chữa, bổ sung Quyết định giải quyết bồi thường)*: Phạm vi dữ liệu chỉ gồm các Quyết định giải quyết bồi thường ở trạng thái `Đã ban hành`.<br>4. *Nguồn 4 (Từ Form Đề nghị tạm ứng kinh phí - Module Cấp kinh phí)*: Chỉ áp dụng khi `Loại đề nghị` là `Đề nghị tạm ứng`. Trường hợp `Loại đề nghị` là `Đề nghị cấp kinh phí bồi thường`, hệ thống KHÔNG dùng popup này mà mở **Popup Tìm kiếm Quyết định giải quyết bồi thường** đặc tả riêng tại tài liệu Cấp kinh phí bồi thường, do đối tượng tìm kiếm khi đó là Quyết định giải quyết bồi thường chứ không phải Vụ việc.<br>   - Danh sách tra cứu chỉ trả về các vụ việc có trạng thái từ `Đang xác minh thiệt hại` trở về sau (`Đang xác minh thiệt hại`, `Đang thương lượng`, `Chờ ban hành QĐ`). Đồng thời **hệ thống tự động loại trừ (không hiển thị)** các vụ việc:<br>     + Đã tồn tại Đề nghị cấp kinh phí bồi thường ở các trạng thái đang có hiệu lực (`Chờ lập đề nghị`, `Chờ duyệt`, `Chờ chi trả`, `Chờ thu hồi`, `Hoàn thành`, `Sung quỹ nhà nước`).<br>     + Đã tồn tại Đề nghị tạm ứng đang có hiệu lực (`Chờ lập đề nghị`, `Chờ duyệt`, `Chờ chi trả`, `Hoàn thành`).<br>5. *Nguồn 5 (Từ Form Yêu cầu hoàn trả)*: Phạm vi dữ liệu chỉ gồm các Quyết định giải quyết bồi thường đã hoàn thành việc chi trả kinh phí cho người bị thiệt hại. |
| 2 | Chọn (trên dòng kết quả) | Button/Row Click | Hệ thống lấy dữ liệu vụ việc/hồ sơ gốc được chọn, tự động điền (autofill) dữ liệu tương ứng theo từng màn hình/nguồn gọi popup và tự động đóng popup:<br><br>**1. Nguồn 1: Gọi từ [MH02 - Màn hình Trình ký/Cập nhật Quyết định giải quyết bồi thường](SRS_BTNN_GiaiQuyetBT_QuyetDinh_GQBT.md#43334-mh02---màn-hình-trình-kýcập-nhật-quyết-định-giải-quyết-bồi-thường) (Module Quyết định giải quyết bồi thường):**<br>- *Mục đích*: Tìm hồ sơ vụ việc YCBT đã hoàn thành thương lượng để lấy dữ liệu lập Quyết định giải quyết bồi thường.<br>- *Dữ liệu kế thừa & Tự động điền*:<br>  + `Mã vụ việc`: Điền mã vụ việc đã chọn (hiển thị dưới dạng hyperlink mở xem chi tiết hồ sơ YCBT).<br>  + Tự động điền toàn bộ thông tin trong **Khối Chi tiết nội dung quyết định**:<br>    * `Tên vụ việc`: Tên vụ việc yêu cầu bồi thường.<br>    * `Người yêu cầu bồi thường`: Họ và tên người yêu cầu bồi thường.<br>    * `Địa chỉ người yêu cầu`: Địa chỉ nơi cư trú của người yêu cầu (Địa chỉ chi tiết, Phường/Xã, Tỉnh/Thành phố).<br>    * `Cơ quan quản lý người thi hành công vụ gây thiệt hại`: Tên cơ quan quản lý người thi hành công vụ gây thiệt hại.<br>    * `Ngày thương lượng`: Ngày lập Biên bản kết quả thương lượng thành công.<br>    * `Phương thức chi trả tiền bồi thường`: Nếu là tiền mặt tự động điền *"Chi trả trực tiếp bằng tiền mặt tại [Tên Cơ quan giải quyết bồi thường]"*; nếu là chuyển khoản tự động điền *"Chi trả qua chuyển khoản"* và điền sẵn các thông tin tài khoản ngân hàng (`Số tài khoản`, `Chủ tài khoản`, `Tên ngân hàng`, `Chi nhánh ngân hàng`).<br>    * `Các quyền, lợi ích hợp pháp khác được khôi phục`: Kế thừa nội dung quyền và lợi ích hợp pháp khác được khôi phục (nếu có).<br>    * `Tổng số tiền bồi thường`: Tổng số tiền thương lượng thành công của vụ việc.<br>    * `Số tiền bồi thường đã tạm ứng`: Số tiền tạm ứng kinh phí đã nhận (nếu có).<br>    * `Số tiền bồi thường còn lại`: Tự động tính = `Tổng số tiền bồi thường` - `Số tiền bồi thường đã tạm ứng`.<br>- Tự động đóng popup sau khi chọn.<br><br>**2. Nguồn 2: Gọi từ [MH02 - Màn hình Nhập liệu hồ sơ vụ việc](#43314-mh02---màn-hình-nhập-liệu-hồ-sơ-vụ-việc) (Module Giải quyết YCBT):**<br>- *Mục đích*: Tìm kiếm vụ việc yêu cầu bồi thường gốc liên quan khi tiếp nhận/nhập liệu hồ sơ mới có liên quan đến vụ việc trước đó.<br>- *Dữ liệu kế thừa & Tự động điền*:<br>  + `Vụ việc yêu cầu bồi thường gốc liên quan`: Điền mã vụ việc gốc (dạng hyperlink mở xem hồ sơ gốc).<br>  + Kế thừa thông tin nhân thân người yêu cầu bồi thường, cơ quan giải quyết và các tài liệu chứng minh thiệt hại liên quan từ vụ việc gốc.<br>- Tự động đóng popup sau khi chọn.<br><br>**3. Nguồn 3: Gọi từ [MH08 - Màn hình Hủy/Sửa chữa, bổ sung Quyết định giải quyết bồi thường](SRS_BTNN_GiaiQuyetBT_QuyetDinh_GQBT.md#433310-mh08---màn-hình-hủysửa-chữa-bổ-sung-quyết-định-giải-quyết-bồi-thường) (Module Quyết định giải quyết bồi thường):**<br>- *Mục đích*: Tìm Quyết định giải quyết bồi thường gốc đã ban hành để thực hiện Hủy (Mẫu 11/BTNN) hoặc Sửa chữa, bổ sung (Mẫu 12/BTNN).<br>- *Dữ liệu kế thừa & Tự động điền*:<br>  + `Quyết định gốc`: Số quyết định, ngày ban hành, ngày hiệu lực, cơ quan ban hành của quyết định gốc.<br>  + `Mã vụ việc`, `Tên vụ việc`, `Người yêu cầu bồi thường`: Kế thừa từ quyết định gốc.<br>  + `Căn cứ ban hành`: Kế thừa danh sách căn cứ pháp lý của quyết định gốc.<br>- Tự động đóng popup sau khi chọn.<br><br>**4. Nguồn 4: Gọi từ Form Đề nghị tạm ứng kinh phí (Module Cấp kinh phí):**<br>- *Phạm vi áp dụng*: Chỉ áp dụng khi `Loại đề nghị` là `Đề nghị tạm ứng`. Với `Đề nghị cấp kinh phí bồi thường`, hệ thống mở Popup Tìm kiếm Quyết định giải quyết bồi thường đặc tả riêng tại tài liệu Cấp kinh phí bồi thường.<br>- *Mục đích*: Tìm hồ sơ vụ việc yêu cầu bồi thường để lập tờ trình đề nghị tạm ứng kinh phí.<br>- *Phạm vi lọc & Điều kiện dữ liệu*: Tuân thủ đúng quy tắc lọc và loại trừ tự động của Nguồn 4 được xác định tại chức năng Tìm kiếm (STT 1).<br>- *Dữ liệu kế thừa & Tự động điền*: Hệ thống điền các trường bên dưới về màn hình **MH02 - Màn hình Lập/Cập nhật đề nghị cấp kinh phí**. Tên trường đích viết theo đúng tên và thứ tự các khối thông tin của MH02; các trường không liệt kê thì hệ thống không tác động.<br>  + **Khối Thông tin chung tờ trình**:<br>    ~ `Mã vụ việc gốc`: Mã vụ việc của bản ghi được chọn, hiển thị dạng liên kết mở màn hình Xem chi tiết vụ việc.<br>    ~ `Tên vụ việc`: Tên vụ việc của bản ghi được chọn.<br>  + **Khối Chi tiết thông tin người yêu cầu bồi thường** (lấy theo hồ sơ vụ việc được chọn):<br>    ~ `Họ và tên người yêu cầu bồi thường`<br>    ~ `Tỉnh/Thành phố`<br>    ~ `Phường/Xã`<br>    ~ `Địa chỉ chi tiết`<br>  + **Khối Bảng nội dung đề xuất cấp tạm ứng** (nạp thành nhiều dòng, mỗi loại thiệt hại có yêu cầu tạm ứng là 01 dòng):<br>    ~ `Nội dung tạm ứng`: Tên loại thiệt hại được đề nghị tạm ứng theo hồ sơ vụ việc gốc.<br>    ~ `Mức đề nghị trong hồ sơ gốc (VNĐ)`: Mức tiền yêu cầu tạm ứng của loại thiệt hại tương ứng trên hồ sơ vụ việc gốc.<br>  + **Khối Người nhận bồi thường và Phương thức chi trả** (lấy theo hồ sơ vụ việc được chọn):<br>    ~ `Họ và tên người nhận`: Họ và tên người yêu cầu bồi thường.<br>    ~ `Số giấy tờ thân nhân`: Số giấy tờ thân nhân của người yêu cầu bồi thường.<br>    ~ `Địa chỉ`: Địa chỉ liên hệ của người yêu cầu bồi thường.<br>    ~ `Phương thức chi trả tiền bồi thường`: Phương thức chi trả đã đăng ký trên hồ sơ vụ việc.<br>    ~ `Chủ tài khoản`, `Số tài khoản`, `Tên ngân hàng`, `Chi nhánh`: Chỉ điền khi `Phương thức chi trả tiền bồi thường` là chuyển khoản.<br>  + Kế thừa thông tin người nhận bồi thường và phương thức chi trả/thông tin tài khoản ngân hàng từ hồ sơ vụ việc gốc.<br>- Tự động đóng popup sau khi chọn.<br><br>**5. Nguồn 5: Gọi từ Form Yêu cầu hoàn trả (Module Yêu cầu hoàn trả):**<br>- *Mục đích*: Tìm Quyết định giải quyết bồi thường đã chi trả xong để lập hồ sơ yêu cầu người thi hành công vụ hoàn trả.<br>- *Dữ liệu kế thừa & Tự động điền*:<br>  + `Số quyết định bồi thường`, `Mã vụ việc`, `Tên vụ việc`.<br>  + `Người thi hành công vụ gây thiệt hại`, `Cơ quan quản lý`, `Tổng số tiền đã bồi thường`.<br>- Tự động đóng popup sau khi chọn. |
