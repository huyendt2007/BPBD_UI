...
| Bảng danh sách vụ việc/hồ sơ yêu cầu bồi thường | - | Không | Danh sách dữ liệu theo tab | Hiển thị danh sách vụ việc/hồ sơ theo tab đang chọn, sắp xếp mặc định theo `Ngày tiếp nhận` giảm dần. |
...
| 2 | Tìm kiếm | Button | Hệ thống tìm kiếm vụ việc theo các tiêu chí lọc đang nhập/chọn trong tab hiện hành, hiển thị kết quả lên bảng và đưa về trang 1. Nếu không có dữ liệu phù hợp, bảng hiển thị trạng thái không tìm thấy vụ việc. Nếu khoảng ngày không hợp lệ, áp dụng [BR-VAL-007] và không thực hiện tìm kiếm. |
...
| 2 | Tìm kiếm nâng cao (Vụ việc xác định cơ quan) | Button | Hệ thống mở **4.3.3.1.9. Popup Tìm kiếm Vụ việc xác định cơ quan giải quyết bồi thường** để tìm theo nhiều tiêu chí khi không nhớ chính xác mã. |
...
| 4 | Tìm kiếm (Vụ việc yêu cầu bồi thường gốc liên quan) | Button | TH1 (Có vụ việc gốc trùng mã và đang ở một trong các trạng thái hợp lệ để liên kết theo [DM_24]): Hệ thống mở **4.3.3.1.8. Popup chuẩn Tìm kiếm vụ việc/hồ sơ gốc liên quan**, tự điền `Mã vụ việc/Số quyết định` trên popup bằng giá trị đã nhập tại ô `Vụ việc yêu cầu bồi thường gốc liên quan`, tự thực hiện tìm kiếm và hiển thị danh sách kết quả để cán bộ chọn vụ việc phù hợp. Hệ thống chỉ tự động điền dữ liệu vào form sau khi cán bộ bấm `Chọn`/click dòng kết quả. |
...
| 5 | Tìm kiếm nâng cao (Vụ việc yêu cầu bồi thường gốc liên quan) | Button | Hệ thống mở **4.3.3.1.8. Popup chuẩn Tìm kiếm vụ việc/hồ sơ gốc liên quan** để tìm theo nhiều tiêu chí khi không nhớ chính xác mã. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Button | TH1 (Không nhập tiêu chí nào): Vi phạm [BR-VAL-001] (yêu cầu nhập tối thiểu 1 tiêu chí), hiển thị [MSG-ERR-VAL-001]. Không thực hiện tìm kiếm. |
