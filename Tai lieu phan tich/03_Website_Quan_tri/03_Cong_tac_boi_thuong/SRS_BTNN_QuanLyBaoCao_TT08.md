...
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Button | Lọc danh sách theo các tiêu chí đang chọn (kết hợp AND), hiển thị kết quả và đưa về trang 1. |
...
| Bảng danh sách đơn vị cấp dưới | Text(1000) | - | Theo dữ liệu | Cột: `Đơn vị`, `Số vụ việc đã nhập`, `Trạng thái` [DM_45], `Ngày gửi`, `Thao tác`. |
