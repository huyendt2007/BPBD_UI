...
| Trung tâm Đăng ký mặc định | Enum(String(100)) | Có | - | Control UI: Combobox.<br>- Bắt buộc nhập - **[BR-VAL-001]**.<br>- Hiển thị **Tên đầy đủ** của Trung tâm giao dịch bảo đảm theo Danh mục [DM_08]. |
