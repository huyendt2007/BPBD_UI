...
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Lọc danh sách cấu hình API trên lưới theo từ khóa và trạng thái đã chọn. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Thực hiện lọc dữ liệu hiển thị trên lưới theo từ khóa và bộ lọc trạng thái. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Thực hiện lọc dữ liệu trên lưới theo từ khóa tìm kiếm và bộ lọc đối tượng áp dụng. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Tìm kiếm dải IP trên lưới cấu hình theo dải IP và trạng thái đã lọc. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Tìm kiếm thông tin liên hệ trên lưới cấu hình theo từ khóa và Loại thông tin. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Tìm kiếm thông tin người ký trên lưới cấu hình theo từ khóa và Đơn vị. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Tìm kiếm thông tin con dấu trên lưới cấu hình theo từ khóa và Đơn vị. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Tìm kiếm thông tin tài khoản trên lưới cấu hình theo từ khóa và Ngân hàng. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :-- | :--------------- | :----------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Tìm kiếm       | Nút         | Tìm kiếm thông tin biểu phí trên lưới cấu hình theo từ khóa, Loại dịch vụ, Trạng thái và khoảng ngày hiệu lực. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Tìm kiếm quy tắc trên lưới cấu hình theo từ khóa và Loại kiểm tra. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Lọc danh sách tham số trên lưới theo từ khóa và Nhóm tham số đã chọn. |
...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | Lọc thông tin hiển thị trên lưới cấu hình MFA. |
