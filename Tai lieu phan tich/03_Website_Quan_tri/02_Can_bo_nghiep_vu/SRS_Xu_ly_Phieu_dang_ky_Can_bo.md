...
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | TH1 (Điều kiện ngày không hợp lệ): Nếu Từ ngày lớn hơn Đến ngày, vi phạm [BR-VAL-007], hệ thống hiển thị message tương ứng đã cấu hình tại MessageList và không thực hiện tìm kiếm. |
