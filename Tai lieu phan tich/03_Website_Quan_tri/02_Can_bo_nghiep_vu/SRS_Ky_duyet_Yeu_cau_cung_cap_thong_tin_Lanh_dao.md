...
| Kết quả tra cứu | Text(4000) | Không | Theo hồ sơ | Chỉ đọc. Kết quả tra cứu đã được Cán bộ lưu và khóa khi trình ký, được lưu trong lịch sử xử lý khi từ chối. |
