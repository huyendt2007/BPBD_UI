...
| **II. Bảng danh sách hồ sơ chờ nhập liệu** | | | | |
| Bảng danh sách hồ sơ | Text(1000) | Có | 20 bản ghi/trang | Chỉ hiển thị hồ sơ giấy thỏa điều kiện tại mục 2. Nếu không có dữ liệu, hiển thị dòng "Không có hồ sơ nào ở trạng thái này hoặc phù hợp với điều kiện tìm kiếm.". |
...
| :--- | :--- | :--- | :--- |
| 1 | Tìm kiếm | Nút | TH1 (Khoảng ngày không hợp lệ): Vi phạm [BR-VAL-007], hiển thị [MSG-ERR-VAL-007], không thực hiện tìm kiếm. |
