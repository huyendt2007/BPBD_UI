...
| :--- | :--- | :--- | :--- |
| 1 | Tra cứu | Nút | Điều kiện hiển thị: Hiển thị khi hồ sơ ở trạng thái "Chờ giải quyết" hoặc "Bị trả lại" và Cán bộ có quyền xử lý hồ sơ giấy CCTT.<br>TH1 (Hồ sơ không ở trạng thái "Chờ giải quyết" hoặc "Bị trả lại"): Vi phạm [BR-CCTT-008]/[BR-CCTT-009], hiển thị [MSG-ERR-DK-005], không gọi dịch vụ tra cứu. |
