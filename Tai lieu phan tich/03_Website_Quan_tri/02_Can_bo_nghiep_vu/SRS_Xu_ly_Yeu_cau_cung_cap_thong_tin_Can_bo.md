...
| STT | Tên chức năng | Định dạng | Mô tả |
| :--- | :--- | :--- | :--- |
| 1 | Tra cứu | Nút | TH1 (Hồ sơ không thuộc trạng thái Cán bộ được phép xử lý): Vi phạm [BR-CCTT-002], hiển thị [MSG-ERR-CCTT-002], không gọi dịch vụ tra cứu. |
