...
| Trạng thái | Enum(String(50)) | Không | Tất cả | Control UI: Combobox.<br>Gồm:<br>+ Tất cả<br>+ Lưu nháp<br>+ Chờ thanh toán<br>+ Hoạt động<br>+ Hết hạn<br>+ Khóa<br>+ Ngưng sử dụng<br>+ Bị từ chối |
