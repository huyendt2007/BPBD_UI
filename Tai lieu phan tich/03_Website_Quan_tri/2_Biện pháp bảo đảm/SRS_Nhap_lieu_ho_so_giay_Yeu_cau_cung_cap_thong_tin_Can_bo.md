...
| 4 | Duyệt chờ ký | Nút | Nút chỉ sáng lên cho phép click khi đã có phiên tra cứu xử lý thành công.<br>- Khi bấm, hệ thống thực hiện:<br>- Ghi nhận các thông tin:<br>+ `Nguồn tiếp nhận` là "Trực tiếp".<br>+ `Cán bộ xử lý` là Họ và tên Cán bộ nhập liệu đang thực hiện thao tác.<br>+ `Mã khách hàng`:<br>* Nếu `Loại khách hàng` là "Có tài khoản trực tuyến": ghi nhận Mã khách hàng là Mã tài khoản trực tuyến của Người yêu cầu đăng ký.<br>* Nếu `Loại khách hàng` là "Khách hàng vãng lai": ghi nhận Mã khách hàng là "Vãng lai".<br>+ Ghi nhận `Thời điểm đăng ký` là ngày giờ hiện tại của hệ thống tại thời điểm thực hiện thành công, lưu đầy đủ theo định dạng dd/mm/yyyy hh:mm:ss.<br>- **Chuyển hồ sơ sang trạng thái "Duyệt chờ ký"**.<br>- Đóng màn hình nhập liệu, quay về [MH01 - Màn hình Danh sách hồ sơ chờ nhập liệu](#432192-mh01---man-hinh-danh-sach-ho-so-cho-nhap-lieu) và hiển thị thông báo thành công [MSG-SUC-CCTT-005] (*"Duyệt yêu cầu cung cấp thông tin thành công."*) dạng Toast. |
| 5 | Trình ký | Nút | Nút chỉ sáng lên cho phép click khi đã có phiên tra cứu xử lý thành công (bao gồm cả trường hợp có dữ liệu và không có dữ liệu theo [BR-CCTT-003]).<br>TH1 (Chưa có phiên tra cứu xử lý thành công hoặc dữ liệu tra cứu đã thay đổi sau lần tra cứu gần nhất): Vi phạm [BR-CCTT-004], hiển thị [MSG-ERR-CCTT-005] dạng Toast. Không mở popup trình ký.<br><br>TH Hợp lệ: Hệ thống thực hiện:<br>- Tự động sinh file PDF dự thảo Yêu cầu cung cấp thông tin theo mẫu `GCN_Mau Giay chung nhan CCTT.pdf`, sử dụng thông tin Người yêu cầu (Khối III) và phiên tra cứu gần nhất (Khối V). Cấu trúc file và mapping dữ liệu tuân thủ [4.3.2.2.7. Quy tắc xử lý kết quả tra cứu và kết xuất PDF kết quả cung cấp thông tin](SRS_Xu_ly_Yeu_cau_cung_cap_thong_tin_Can_bo.md#43227-quy-tac-xu-ly-ket-qua-tra-cuu-va-ket-xuat-pdf-ket-qua-cung-cap-thong-tin).<br>- Mở [MH04 - Popup Trình ký kết quả cung cấp thông tin](SRS_Xu_ly_Yeu_cau_cung_cap_thong_tin_Can_bo.md#43225-mh04---popup-trinh-ky-ket-qua-cung-cap-thong-tin).<br>- Khi Xác nhận trình ký thành công: hồ sơ chuyển từ "Chờ giải quyết"/"Bị trả lại" sang "Chờ ký" theo [BR-CCTT-008], đóng popup và MH03, quay về [MH01 - Màn hình Danh sách hồ sơ chờ nhập liệu](#432192-mh01---man-hinh-danh-sach-ho-so-cho-nhap-lieu) và hiển thị [MSG-SUC-CCTT-008] dạng Toast. |
| 6 | Hủy | Nút | TH1 (Cán bộ chưa nhập hoặc chưa thay đổi dữ liệu nào): Hệ thống đóng màn hình nhập liệu và quay về màn hình nguồn đã mở hồ sơ, không hiển thị thông báo xác nhận.<br><br>TH Hợp lệ: Cán bộ đã nhập hoặc thay đổi dữ liệu nhưng chưa gửi duyệt. Hệ thống thực hiện:<br>+ Hiển thị popup xác nhận [MSG-CFM-UCPS-001] - *"Dữ liệu đang thao tác chưa được lưu. Bạn có chắc chắn muốn hủy bỏ?"* gồm 02 nút "Đồng ý" và "Hủy".<br>+ Chọn "Đồng ý": Hệ thống hủy toàn bộ dữ liệu đang thao tác, đóng màn hình nhập liệu, quay về màn hình nguồn đã mở hồ sơ và giữ nguyên trạng thái hồ sơ.<br>+ Chọn "Hủy": Hệ thống đóng popup, ở lại màn hình nhập liệu và giữ nguyên toàn bộ dữ liệu đang thao tác. |
